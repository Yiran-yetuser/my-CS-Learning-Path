...
好难好难。刚拿到题目的时候手足无措，然后看了提示才知道DSU。有了DSU后手搓了一个线性查找的方法，debug多次后也确实通过了，就是时间和空间都太慢了5555。<br>
然后去看了官解和灵茶山艾府的解答，稍微理解了Kruskal算法和二分查找。这题本质要做出来其实不难（如果不考虑复杂度的话），但是实际上优化才是难点。
