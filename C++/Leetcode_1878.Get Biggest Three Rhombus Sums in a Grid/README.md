...
好久没这么酣畅淋漓地写代码了！<br>
这道题刚看到的时候想的是O(n^4)的算法，但是感觉不太对劲，看了题解后觉得还是用前缀和（用空间换时间），于是开始搓了。<br>
中间出的几个bug主要是前缀和数组和gird数组之间下标差1容易出现逻辑错误、菱形算边的时候出现逻辑错误、忘记减掉顶点以及返回数组没整理好。<br>
最后还是拿下了！让ai帮我润色了一下注释
